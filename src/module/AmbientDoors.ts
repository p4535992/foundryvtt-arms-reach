...
export function onDoorMouseDown(event) {
	...
	const doorData = this.wall.data.flags[MODULE_NAME]?.doorData || defaultDoorData();
...
export function defaultDoorData() {
	return {
...
export const preUpdateWallHandler = async function(scene, object, updateData, diff, userID){
...
export const renderWallConfigHandler = function(app, html, data) {
