  ...
  globalInteractionDistance: function (
    ...
    if (globalInteraction > 0) {
      ...
      if (
        ...
        if (!character) {
          iteractionFailNotification(i18n(`${CONSTANTS.MODULE_NAME}.noCharacterSelectedForLight`));
          return false;
        } else {
          ...
          if (isNotNearEnough) {
            ...
            if (tokenName) {
              ...
              iteractionFailNotification(i18n(`${CONSTANTS.MODULE_NAME}.lightsNotInReach`));
            }
            return false;
          } else {
            return true;
